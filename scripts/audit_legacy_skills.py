...
MAP = {
    ...
    "planner-input-alignment-gate": "planner-impact-and-invariants", "planner-repository-impact-map": "planner-impact-and-invariants", "planner-invariant-consistency-design": "planner-impact-and-invariants", "planner-increment-task-sequencing": "planner-delivery-slices", "planner-test-observability-plan": "planner-verification-and-handoff", "planner-migration-rollout-rollback": "planner-migration-rollout", "planner-engineer-review-handoff": "planner-verification-and-handoff",
    "builder-authority-baseline-gate": "builder-baseline-and-red", "builder-criterion-red-proof": "builder-baseline-and-red", "builder-scoped-implementation": "builder-bounded-change", "builder-migration-config-safety": "builder-migration-config-safety", "builder-verification-receipt": "builder-verification-and-deviation", "builder-deviation-escalation": "builder-verification-and-deviation",
    "tester-evidence-plan": "tester-evidence-and-negative-control", "tester-negative-control": "tester-evidence-and-negative-control", "tester-behaviour-side-effect-checks": "tester-adversarial-behaviour", "tester-concurrency-boundary-checks": "tester-concurrency-boundaries", "tester-defect-reproduction": "tester-defect-and-handoff", "tester-coverage-classification-handoff": "tester-defect-and-handoff",
    ...
    "curator-finding-provenance": "curator-provenance-and-classification", "curator-learning-classification": "curator-provenance-and-classification", "curator-destination-routing": "curator-proposal-and-history", "curator-proposal-governance": "curator-proposal-and-history", "curator-version-history-maintenance": "curator-version-history", "curator-next-use-evaluation": "curator-next-use-evaluation",
}
CONTRIBUTION = {
