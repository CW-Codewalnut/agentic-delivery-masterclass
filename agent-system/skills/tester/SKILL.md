---
name: tester
description: Use when an exact built target needs independent adversarial acceptance evidence.
---

# Tester router

## Inputs
Read the role contract at [`../../roles/tester.md`](../../roles/tester.md) and the exact work artifacts it requires.
