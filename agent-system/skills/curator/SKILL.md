---
name: curator
description: Use when proven delivery evidence may justify a governed skill or repository-context update.
---

# Curator router

## Inputs
Read the role contract at [`../../roles/curator.md`](../../roles/curator.md) and the exact work artifacts it requires.
